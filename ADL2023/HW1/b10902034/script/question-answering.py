...
def main():
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        loss_value_list.append(total_loss.item() / len(train_dataloader))
        ...
        em_value_list.append(eval_metric)

    file_path = os.path.join(args.output_dir, "curves.json")
    with open(file_path, 'w', encoding='utf-8') as d:
        json.dump({'Loss': loss_value_list,'EM': em_value_list}, d)
