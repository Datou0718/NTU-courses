...
def main():
    ...
    mse_pca, mse_ae, mse_deno_ae = pca.plot(), autoencoder.plot(), deno_autoencoder.plot()
    print(f"MSE with PCA: {mse_pca}")
    print(f"MSE with Autoencoder: {mse_ae}")
    print(f"MSE with DenoisingAutoencoder: {mse_deno_ae}")
